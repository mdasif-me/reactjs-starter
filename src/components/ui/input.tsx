  ...
  return (
    <span data-slot="control" className="relative block w-full">
      <InputPrimitive
        ref={ref}
        className={cx(
          '[--input-focus-bg:theme(--color-primary-subtle/50%)]',
          ...
          'invalid:border-danger focus:invalid:border-danger focus:invalid:ring-danger invalid:enabled:hover:border-danger focus:invalid:enabled:hover:border-danger invalid:bg-[#FFF0F3] focus:invalid:bg-[#FFF0F3]',
