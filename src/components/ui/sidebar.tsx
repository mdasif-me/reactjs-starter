      ...
      className={composeRenderProps(
        ...
        (className, { isPressed, isFocusVisible, isHovered, isDisabled }) =>
          twMerge([
            ...
            isCurrent &&
              '[&_.text-muted-fg]:text-fg/80 font-medium text-(--sidebar-current-fg) hover:bg-(--sidebar-current-bg) hover:text-(--sidebar-current-fg) **:data-[slot=icon]:text-(--sidebar-current-fg) hover:**:data-[slot=icon]:text-(--sidebar-current-fg)',
            isFocusVisible && 'inset-ring-sidebar-ring inset-ring outline-hidden',
            (isPressed || isHovered) &&
          ...
          {badge &&
            (state !== 'collapsed' ? (
              <span
                ...
                className="inset-ring-sidebar-border bg-fg/5 group-hover/sidebar-item:inset-ring-muted-fg/30 absolute inset-y-1/2 right-1.5 h-5.5 w-auto -translate-y-1/2 rounded-full px-2 text-[10px]/5.5 inset-ring-1 transition-colors group-data-current:inset-ring-transparent"
              >
                {badge}
              </span>
            ) : (
  ...
  return (
    <main
      ...
      className={twMerge(
        ...
        'peer-data-[intent=inset]:border-sidebar-border peer-data-[intent=inset]:border md:peer-data-[intent=inset]:m-2 md:peer-data-[intent=inset]:ml-0 md:peer-data-[intent=inset]:rounded-2xl md:peer-data-[intent=inset]:peer-data-[state=collapsed]:ml-2',
